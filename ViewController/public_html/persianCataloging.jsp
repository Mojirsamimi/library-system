        ...
        <f:facet name="center">
          <af:panelTabbed id="pt2">
            <af:showDetailItem stretchChildren="first"
              ...
              <af:panelGroupLayout layout="scroll" id="pgl10">
                <af:showDetailHeader text="#{viewcontrollerBundle.cataloging_book_cataloging}"
                                     ...
                                     helpTopicId="persianCataloging">
                  <f:facet name="toolbar">
                    <af:toolbar id="t1">
                      <af:group id="g1">
                        <af:commandButton text="#{viewcontrollerBundle.cataloging_preview}"
                                          id="cb3"
                      ...
                      <fadak:ToolbarSet debug="true"
                                        ...
                                        id="ts1"
                                        after_create="#{viewScope.back.create_Persian}"
                                        ></fadak:ToolbarSet>
                    </af:toolbar>
                  </f:facet>
                  ...
                  <af:separator id="s1"/>
                  <af:panelBox id="pb2" disclosed="false"
                      ...
                      <af:panelHeader text="#{viewcontrollerBundle.cataloging_role}"
                        ...
                        <f:facet name="toolbar">
                          <af:toolbar id="t23">
                            ...
                            <af:commandImageLink disabled="#{!bindings.Delete.enabled}"
                                                 id="cil6"
                                                 partialSubmit="true"
                      ...
                      <af:panelFormLayout rows="1" maxColumns="4" id="pfl3"
                        ...
                        <af:panelGroupLayout layout="horizontal" id="pgl1"
                          ...
                          <af:inputText value="#{bindings.Title1.inputValue}"
                                        ...
                                        id="it41" partialTriggers="::r1 cil3"
                                        readOnly="true">
                      ...
                      <af:panelHeader text="#{viewcontrollerBundle.cataloging_language}"
                        ...
                        <af:panelCollection id="panelCollection1"
                          ...
                          <af:table value="#{bindings.VbookLanguageVO1.collectionModel}"
                            ...
                            <af:column sortProperty="LangArtId" sortable="true"
                                       headerText="#{bindings.VbookLanguageVO1.hints.LangArtId.label}"
                                       id="c44">
            ...
            <af:showDetailItem id="sdi1" stretchChildren="first"
                               text="#{viewcontrollerBundle.details_description}">
              <af:panelGroupLayout id="pgl9" layout="scroll">
                <af:panelBox text="" id="pb11">
                  ...
                  <af:panelFormLayout rows="1" id="pfl8" labelAlignment="start"
                    ...
                    <af:panelCollection featuresOff="statusBar viewMenu detach"
                                        id="pc10" inlineStyle="width:470px;"
                                        partialTriggers="ts4">
                      ...
                      <f:facet name="toolbar">
                        <af:toolbar id="t13" partialTriggers="t12">
                          ...
                          <fadak:ToolbarSet iteratorname="VbookSubjectVO1Iterator"
                                            id="ts4" showcommit="false"
                                            showfirst="false" showlast="false"
                                            shownext="false"
                                            showprevious="false"
                                            disabled_delete="#{bindings.VbookSubjectVO1Iterator.currentRow==null}"
                                            showcreate="false" showquery="false"
                                            showrefresh="false"
                                            showrollback="false"
                                            showsearch="false"
                                            commitafterdelete="false"></fadak:ToolbarSet>
                        </af:toolbar>
                      </f:facet>
                    </af:panelCollection>
                  </af:panelFormLayout>
                  <af:panelBox text="#{viewcontrollerBundle.added_entries}"
                    ...
                    <af:panelFormLayout id="pfl11" labelAlignment="start">
                      <f:facet name="footer"/>
                      <af:outputLabel for="pc3" inlineStyle="font-weight:bold;"
                                      id="ol4"
                                      value="#{viewcontrollerBundle.other_providers}"/>
                ...
                <f:facet name="toolbar">
                  <af:toolbar id="t3">
                    <fadak:ToolbarSet debug="true"
                                      ...
                                      RollbackAfterUnsuccessfulCommit="false"
                                      id="ts10"
                                      after_create="#{viewScope.back.create_Persian}"></fadak:ToolbarSet>
                  </af:toolbar>
                </f:facet>
