...
// ---------------------------------------------------------------------
public class MainSeeProviderRowImpl extends TemplateViewRow {
    @Override
    protected void create(AttributeList attributeList) {
        super.create(attributeList);
      setLabcol((Number)((AppModuleImpl)getApplicationModule()).getSession().getUserData().get("labcolno"));
    ...
    public enum AttributesEnum {
        ArtId {
            public Object get(MainSeeProviderRowImpl obj) {
                return obj.getArtId();
            }

            public void put(MainSeeProviderRowImpl obj, Object value) {
        ...
        public abstract Object get(MainSeeProviderRowImpl object);

        public abstract void put(MainSeeProviderRowImpl object, Object value);
    ...
    /**
     * Gets the associated <code>RowIterator</code> using master-detail link SeeProvider.
     */
    public RowIterator getSeeProvider() {
        return (RowIterator)getAttributeInternal(SEEPROVIDER);
    }
