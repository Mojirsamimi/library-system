...
// ---    Wed Jun 27 13:28:03 GMT+03:30 2012
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class PenaltyPaymentImpl extends EntityImpl {
    ...
    public enum AttributesEnum {
        Labcol {
            public Object get(PenaltyPaymentImpl obj) {
                return obj.getLabcol();
            }

            public void put(PenaltyPaymentImpl obj, Object value) {
        ...
        public abstract Object get(PenaltyPaymentImpl object);

        public abstract void put(PenaltyPaymentImpl object, Object value);
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = EntityDefImpl.findDefObject("org.parsisys.tehranuniversity.library.model.eo.PenaltyPayment");
        }
    ...
    protected void doDML(int operation, TransactionEvent e) {
      ...
      if(operation==DML_INSERT){
        SequenceImpl si = new SequenceImpl("seq_penalty_payment_art_id",getDBTransaction());
